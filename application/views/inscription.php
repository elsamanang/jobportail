                ...
                <?php echo form_open_multipart('logupEntreprise','class =""');?>
                    <div class="row">
                        <div class="input-field col s6">
                            ...
                            <input id="icon_name" type="text" class="validate" name="nomEmployeur">
                            <label for="icon_name">Nom Entreprise <?php echo form_error('nomEmployeur') ?></label>
                            <span><?php echo form_error('nomEmployeur') ?></span> 
                        </div>
                        <div class="input-field col s6">
                            <i class="material-icons prefix">location_on</i>
                            <input id="icon_adresse" type="text" class="validate" name="adresseEmployeur">
                            <label for="icon_adresse">Adresse</label>
                            <?php echo form_error('adresseEmployeur') ?>
                        </div>
                        <div class="input-field col s6">
                            <i class="material-icons prefix">mail_outline</i>
                            <input id="icon_email" type="email" class="validate" name="emailEmployeur">
                            <label for="icon_email">Email</label>
                            <?php echo form_error('emailEmployeur') ?>
                        </div>
                        <div class="input-field col s6">
                            <i class="material-icons prefix">phone</i>
                            <input id="icon_telephone" type="tel" class="validate" name="telephoneEmployeur">
                        ...
                        <div class="input-field col s6">
                            ...
                            <input id="icon_pwd" type="password" class="validate" name="pwd">
                            <label for="icon_pwd">Password</label>
                            <?php echo form_error('pwd') ?>
                        </div>
                        <div class="input-field col s6">
                            <i class="material-icons prefix">lock</i>
                            <input id="icon_pwdconf" type="password" class="validate" name="pwdconf">
                ...
                <?php echo form_open_multipart('logupPersonne','class =""');?>
                    <div class="row">
                        <div class="input-field col s6">
                            ...
                            <input id="icon_nom" type="text" class="validate" name="nomDemandeur">
                            <label for="icon_nom">Nom </label>
                            <?php echo form_error('nomDemandeur') ?>
                        </div>
                        <div class="input-field col s6">
                            <i class="material-icons prefix">person</i>
                            <input id="icon_prenom" type="text" class="validate" name="prenomDemandeur">
                            <label for="icon_prenom">Prenom </label>
                            <?php echo form_error('prenomDemandeur') ?>
                        </div>
                        <div class="input-field col s6">
                            <i class="material-icons prefix">school</i>
                            <input id="icon_titre" type="text" class="validate" name="titre">
                            <label for="icon_titre">Titre </label>
                            <?php echo form_error('titre') ?>
                        </div>
                        <div class="input-field col s6">
                            <i class="material-icons prefix">location_on</i>
                            <input id="icon_adress" type="text" class="validate" name="adresseDemandeur">
                            <label for="icon_adress">Adresse</label>
                            <?php echo form_error('adresseDemandeur') ?>
                        </div>
                        <div class="input-field col s6">
                            <i class="material-icons prefix">mail_outline</i>
                            <input id="icon_mail" type="email" class="validate" name="emailDemandeur">
                            <label for="icon_mail">Email</label>
                            <?php echo form_error('emailDemandeur') ?>
                        </div>
                        <div class="input-field col s6">
                            <i class="material-icons prefix">phone</i>
                            <input id="icon_phone" type="tel" class="validate" name="telephoneDemandeur">
                        ...
                        <div class="input-field col s6">
                            ...
                            <input type="text" class="datepicker" placeholder="Date de Naissance" id="dateNaissance" name="dateNaissance">
                            <label for="dateNaissance">Date Naissance</label>
                            <?php echo form_error('dateNaissance') ?>
                        </div>
                        <div class="input-field col s6">
                            <i class="material-icons prefix">public</i>
                            <input id="icon_nation" type="text" class="validate" name="nationalite">
                            <label for="icon_nation">Nationalite</label>
                            <?php echo form_error('nationalite') ?>
                        </div>
                        <div class="input-field col s6">
                            <i class="material-icons prefix">local_post_office</i>
                            <input id="icon_civil" type="text" class="validate" name="etatCivil">
                        ...
                        <div class="input-field col s6">
                            <i class="material-icons prefix">lock</i>
                            <input id="icon_passwd" type="password" class="validate" name="pwd">
                            <label for="icon_passwd">Password</label>
                            <?php echo form_error('pwd') ?>
                        </div>
                        <div class="input-field col s6">
                            <i class="material-icons prefix">lock</i>
                            <input id="icon_passwdconf" type="password" class="validate" name="pwdconf">
