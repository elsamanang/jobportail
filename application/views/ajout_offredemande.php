	...
	<div id="body">
        <?php echo form_open('demandeur/create_action','class ="form-horizontal form-label-left"');?>
            <div class="form-group">
                <label for="int">Fk IdOffre <?php echo form_error('fk_idOffre') ?></label>
                <input type="text" class="form-control" name="fk_idOffre" id="fk_idOffre" placeholder="Fk IdOffre"/>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label for="datetime">DateSoumission <?php echo form_error('dateSoumission') ?></label>
                <input type="text" class="form-control" name="dateSoumission" id="dateSoumission" placeholder="DateSoumission"/>
            </div>
